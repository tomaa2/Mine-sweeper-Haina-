...
public class GameResultsController {
    ...
    /**
     * Parse duration stored in CSV.
     * Supports both "HH:MM:SS" and raw seconds (old files).
     */
    ...
    /**
     * Parse time from CSV.
     * Supports both LocalDateTime ISO string (old) and "HH:MM:SS" (new).
     */
    private LocalDateTime parseDateTimeOrTime(String raw) {
        ...
        try {
            if (raw.contains("T")) {
                ...
                LocalTime t = LocalTime.parse(raw, TIME_FORMATTER);
    ...
    public void saveGameHistory() {
        ...
        try (CSVWriter writer = new CSVWriter(new FileWriter(filePath))) {
            ...
            for (GameSummary g : games) {
                ...
                String startTimeStr = g.getStartTime()
                                       .toLocalTime()
                                       .format(TIME_FORMATTER);
                String endTimeStr = g.getEndTime()
                                     .toLocalTime()
                                     .format(TIME_FORMATTER);
